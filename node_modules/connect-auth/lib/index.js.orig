...
=======
          ...
          if(error) {
            callback(error); // I really wish the plugins code logged errors..
          }
>>>>>>> 57d3e89... Add initial/prototype support for a 3rd authentication state 'undefined' for use by redirects or other 'pending' multi-request style strategies
          else {
